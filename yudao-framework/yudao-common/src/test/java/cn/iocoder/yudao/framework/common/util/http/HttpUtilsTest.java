...
public class HttpUtilsTest {
    ...
    public void testReplaceUrlQuery_replace() {
        ...
        assertEquals("https://example.com/path?b=2&a=3", result);
    }

    @Test
    public void testReplaceUrlQuery_add() {
        // 准备参数
        String url = "https://example.com/path?a=1";
        // 调用
    ...
    public void testReplaceUrlQuery_noQuery() {
        ...
        // 断言
        assertEquals("https://example.com/path?a=1", result);
    }
    ...
    public void testReplaceUrlQuery_emptyValue() {
        ...
        // 断言：保留 key，value 为空
        assertEquals("https://example.com/path?a=", result);
    }
