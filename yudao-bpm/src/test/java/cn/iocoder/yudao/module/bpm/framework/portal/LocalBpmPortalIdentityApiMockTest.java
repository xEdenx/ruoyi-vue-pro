...
class LocalBpmPortalIdentityApiMockTest {
    ...
    void listSelectableDirectory_returnsPortalStringIds() {
        assertEquals(List.of("portal-admin-d5e6", "portal-business-owner-g1h2", "portal-executive-n6p7",
                        "portal-finance-r8s9", "portal-legal-h2j3", "portal-legal-j3k4", "portal-manager-b3c4", "portal-procurement-q7r8", "portal-requester-a1f2",
        ...
        assertEquals(List.of("portal-dept-admin", "portal-dept-business", "portal-dept-executive", "portal-dept-finance",
                        "portal-dept-general", "portal-dept-legal", "portal-dept-procurement", "portal-dept-risk", "portal-dept-supplier"),
